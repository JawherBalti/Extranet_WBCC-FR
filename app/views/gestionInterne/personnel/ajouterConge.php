...
<div class=" mt-3" id="accordionFiltrea">
                    ...
                    <tbody>
                        <?php foreach ($typesConge as $index => $typeConge) { ?>
                            <tr>
                                ...
                                <td>BTN</td>
                                <td ><?php echo $typeConge->type; ?></td>
                                <td><?php echo $typeConge->quotas; ?></td>
                                <td><?php echo $typeConge->politique; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
                            ...
                            <div class="col-md-12 mx-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <small class="text-danger" id="quotaCongeError">Ce champ est requis.</small>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-left">
                                        ...
                                        <div id="politiqueEditor" style="height: 200px;" ></div>
                                     
                                        <textarea id="justification" class="form-control" style="display:none;"></textarea>
                                    </div>
                                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var quill = new Quill('#politiqueEditor', {
                theme: 'snow',
            ...
            $(document).ready(function () {
                $('#leaveRequestForm').on('submit', function (event) {
                    ...
                    var politique = quill.getText().trim(); // Récupère et nettoie le texte de la justification
                    ...
                    formData.append('politique', politique); // Ajoute la politique à FormData
